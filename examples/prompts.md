...
每张图只讲一个核心结构，Aiko 必须承担核心动作；不要做 PPT 信息图，不要可爱卡通。
...
```text
Use $ian-xiaohei-illustrations 这张图方向对，但 Aiko 有点像装饰。
请保持核心意思不变，重生成一版：让 Aiko 成为真正推动结构运转的人。
画面更怪一点，但仍然纯白、清爽、少字。
```
...
```text
Use $ian-xiaohei-illustrations 输出 5 个不同主题的 Aiko 正文配图效果。
